...
! $magisk || {
  ...
  ln -sf $installDir/djs-config.sh $installDir/system/bin/djsc
  ln -sf $installDir/djs-config.sh $installDir/system/bin/djs-config

  ln -sf $installDir/service.sh $installDir/system/bin/djsd
  ln -sf $installDir/service.sh $installDir/system/bin/djs-daemon

  ln -sf $installDir/djs-status.sh $installDir/system/bin/djs,
  ln -sf $installDir/djs-status.sh $installDir/system/bin/djs-status

  ln -sf $installDir/djs-stop.sh $installDir/system/bin/djs.
  ln -sf $installDir/djs-stop.sh $installDir/system/bin/djs-stop

  ln -sf $installDir/djs-version.sh $installDir/system/bin/djsv
  ln -sf $installDir/djs-version.sh $installDir/system/bin/djs-version
}
...
- $id commands may require the "/dev/.$domain/$id/" prefix (e.g., /dev/.$domain/$id/${id}c) until system is rebooted.
- Daemon started."
